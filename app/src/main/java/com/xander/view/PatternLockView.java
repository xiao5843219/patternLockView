...
import com.xander.listener.PatternLockViewListener;
import com.xander.utils.PatternLockUtils;
import com.xander.utils.ResourceUtils;
...
public class PatternLockView extends View {
    ...
    */
    ...
    // Width will be fixed. The height will be the minimum of width and height
    private static final int ASPECT_RATIO_WIDTH_BIAS = 1;
    // Height will be fixed. The width will be the minimum of width and height
    private static final int ASPECT_RATIO_HEIGHT_BIAS = 2;
    private static final int CORRECT = 0;
    private static final int AUTO_DRAW = 1;
    ...
    public PatternLockView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mWrongStateColor = typedArray.getColor(R.styleable.PatternLockView_wrongStateColor,
                    ResourceUtils.getColor(getContext(), R.color.colorAccent));
    ...
    public void setWrongStateColor(int wrongStateColor) {
        mWrongStateColor = wrongStateColor;
    }

    public void setCorrectStateColor(int correctStateColor) {
